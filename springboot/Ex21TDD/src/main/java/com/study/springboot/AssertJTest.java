...
public class AssertJTest {
    ...
    void test2(){
        ...
        Assertions.assertThat(list)
                ...
                .contains("1")
                .doesNotContainNull()
                .containsSequence("2","3"); // 2 다음에 3이 있는지
    }
    ...
    void test5(){
        ...
        String input = "abc";
        //when then
        //"java.lang.StringIndexOutOgBoundsException: String index out of range : 3"
    ...
    void test8(){
        //given when
        User user = new User("hong","theif","bank@mail.com");
        //then
        //softAssertions : 동시에 여러 테스트를 진행하고,
        //중간에 에러가 나도 모든 검사를 수행한 후에 결과를 보여줌
